        ...
        RowLayout {
            ...
            StyledText {
                ...
                color: root.currentIndex >= 0
                    ...
                    : Colors.opacify(Appearance.colors.m3on_surface_variant, 0.7)
                font.pixelSize: 16
        ...
        popup: Popup {
            ...
            background: Rectangle {
                ...
                layer.effect: MultiEffect {
                    shadowEnabled: true
                    shadowColor: Colors.opacify(Appearance.colors.m3shadow, 0.25)
                    shadowBlur: 0.4
            ...
            contentItem: ListView {
                ...
                delegate: ItemDelegate {
                    ...
                    background: Rectangle {
                        color: {
                            if (itemMouse.pressed) return Colors.opacify(Appearance.colors.m3primary, 0.12)
                            if (itemMouse.containsMouse) return Colors.opacify(Appearance.colors.m3primary, 0.08)
                            if (index === root.currentIndex) return Colors.opacify(Appearance.colors.m3primary, 0.08)
                            return "transparent"
                        }
                    ...
                    contentItem: StyledText {
                        text: modelData
                        color: index === root.currentIndex ? Appearance.colors.m3primary : Appearance.colors.m3on_surface
                        font.pixelSize: 16
                        verticalAlignment: Text.AlignVCenter
                        leftPadding: 16
                    }
